...
namespace ZyperWin__
{
    public partial class Optimize : UserControl
    {
        ...
        private void InitializeTreeView()
        {
            ...
            AddTreeItem(xingneng, "42、关闭Windows 跟踪应用启动情况", "42、关闭Windows 跟踪应用启动情况");
            AddTreeItem(xingneng, "43、关闭在应用商店中查找关联应用", "43、关闭在应用商店中查找关联应用");
            AddTreeItem(xingneng, "44、去除搜索页面信息流和热搜", "44、去除搜索页面信息流和热搜");
            AddTreeItem(xingneng, "45、关闭TSX漏洞补丁", "45、关闭TSX漏洞补丁");
            AddTreeItem(xingneng, "46、开启GPU硬件加速", "46、开启GPU硬件加速");
            ...
            AddTreeItem(yinsi, "2、禁用开始屏幕建议", "2、禁用开始屏幕建议");
            ...
            AddTreeItem(yinsi, "30、禁用搜索数据收集", "30、禁用搜索数据收集");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            SelectItemsByTag(
                ...
                "24、禁用NTFS链接跟踪服务",
                "25、禁止自动维护计划",
                "32、优化处理器性能、内存设置、硬盘读写",
                "33、加快预读能力改善速度",
                "34、禁止系统自动生成错误报告",
                "37、关闭程序兼容性助手",
                "40、优化Windows Search和小娜的设置",
                "41、关闭广告 ID",
                "42、关闭-允许 Windows 跟踪应用启动情况以改进'开始'菜单和搜索结果",
                "43、关闭在应用商店中查找关联应用",
                "44、去除搜索页面信息流和热搜",
                "46、开启GPU硬件加速",
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            SelectItemsByTag(
                ...
                "28、将文件管理系统缓存增加至256MB以提高性能", // 高级选项
                "29、关闭预读",
        ...
        private void UpdateLabelBasedOnTag(string tag)
        {
            ...
            switch (tag)
            {
                ...
                case "27、禁止系统内核与驱动程序分页到硬盘":
                    ...
                    break;
                case "28、将文件管理系统缓存增加至256MB以提高性能":
                    label2.Text = "增大文件系统缓存，提升文件操作性能";
                    break;
                case "29、关闭预读":
                    label2.Text = "禁用预读功能，减少磁盘占用";
                    break;
                ...
                case "31、禁用保留的存储":
                    ...
                    break;
                case "32、优化处理器性能、内存设置、硬盘读写":
                    label2.Text = "全面优化系统性能设置";
                    break;
                case "33、加快预读能力改善速度":
                ...
                case "41、关闭广告 ID":
                    ...
                    break;
                case "42、关闭-允许 Windows 跟踪应用启动情况以改进'开始'菜单和搜索结果":
                    label2.Text = "禁止跟踪应用启动行为";
                    break;
                case "43、关闭在应用商店中查找关联应用":
                    label2.Text = "彻底禁用应用商店关联搜索";
                    break;
                case "44、去除搜索页面信息流和热搜":
                ...
                case "2、弹出USB磁盘后彻底断开其电源":
                    ...
                    break;
                case "3、*VHD启动时不要将VHD动态文件扩展到最大以节省磁盘空间":
        ...
        private async void button7_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.Yes)
            {
                try
                {
                    ...
                    MessageBox.Show(completionMessage, "完成", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                catch (Exception ex)
                {
                    // 出错时也刷新状态
            ...
            try
            {
                switch (commandName)
                {
                    ...
                    case "SetServiceStart":
                        ExecuteSetServiceStartEnhanced(command); // 使用增强版本
                        break;
                    case "ExplorerNotify":
        ...
        private void ExecuteExplorerNotify(XElement command)
        {
            ...
            try
            {
                // 发送WM_SETTINGCHANGE消息通知资源管理器刷新
                IntPtr HWND_BROADCAST = (IntPtr)0xFFFF;
                const int WM_SETTINGCHANGE = 0x001A;
                IntPtr result = IntPtr.Zero;

                // 使用SendMessageTimeout避免阻塞
            ...
            {
                Console.WriteLine($"资源管理器通知失败: {ex.Message}");
            }
        }
        ...
        private bool CheckOptimizationStatus(string itemTag)
        {
            ...
            switch (itemTag)
            {
                ...
                case "18、禁用诊断服务":
                    return CheckServiceStatus("DiagTrack", "4"); // 4 = 禁用
                case "24、禁用NTFS链接跟踪服务":
                    return CheckServiceStatus("TrkWks", "4"); // 4 = 禁用
            }
